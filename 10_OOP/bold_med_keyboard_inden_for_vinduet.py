# [[file:10_OOP.org::*Den bold må altså ikke ryge ud af vinduet!][Den bold må altså ikke ryge ud af vinduet!:1]]
import arcade
...
main()
# Den bold må altså ikke ryge ud af vinduet!:1 ends here
